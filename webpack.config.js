...
const commonConfig = merge([
	{
		...
		plugins: [
			new CopyWebpackPlugin([{
				from: paths.lib + '/vendors/jquery.postmessage.js',
...
module.exports = (env) => (
	env === 'production' ? [libraryMinConfig, libraryConfig] : libraryConfig
);
